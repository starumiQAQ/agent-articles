...
收集高质量 AI Agent 构建相关的文章、论文和最佳实践。
...
- [Building Effective Agents（构建有效的 AI 智能体）](./anthropic/building-effective-agents.md) — 2024-12-19
  - 智能体的定义、何时使用智能体、常见工作流模式（提示链、路由、并行化、编排器-工作者、评估器-优化器）、工具设计原则
